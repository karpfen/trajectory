...
#' @importFrom leaflet addProviderTiles fitBounds leafletProxy addLayersControl
#' @importFrom leaflet clearShapes clearMarkers clearControls addPolylines
#' @importFrom leaflet addCircleMarkers addLegend addScaleBar scaleBarOptions
